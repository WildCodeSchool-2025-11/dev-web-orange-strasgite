		...
		<>
			...
			<div className="mentions-container">
				...
				<p>
					...
					du site et des services par Ehpad full Stack et de définir les
					...
					l'accès des services proposés par le site. www.Strasgite.fr se réserve
					le droit de modifier unilatéralement et à tout moment le contenu des
					présentes CGU.<p></p>
					ARTICLE 1 : Les mentions légales L'édition du site www.Strasgite.fr
					est assurée par la Société SARL Ehpad full Stack au capital de
					1,000000000 euros, immatriculée au RCS de SAUBION sous le numéro
					123456789, dont le siège social est situé au 1 rue de la Wild Numéro
					de téléphone 0622157875 Adresse e-mail : wws77@gmail.com. Le Directeur
					de la publication est : EHPAD FULL STACK L'hébergeur du site
					www.Strasgite.fr est la société VERCEL, dont le siège social est situé
					au 1 rue du ciel, avec le numéro de téléphone : 1234567892.
					<p></p>
					ARTICLE 2 : Accès au site Le site www.Strasgite.fr permet à
					l'Utilisateur un accès gratuit aux services suivants : Le site
					internet propose les services suivants : Réservation de chambres Le
					...
					réservés, l’Utilisateur membre 1 s’engage à fournir des informations
					...
					Utilisateur membre régulièrement inscrit pourra également solliciter
					sa désinscription en se rendant à la page dédiée sur son espace
					personnel. Celle-ci sera effective dans un délai raisonnable. Tout
					événement dû à un cas de force majeure ayant pour conséquence un
					...
					responsabilité de www.Strasgite.fr. Dans ces cas, l’Utilisateur
					...
					relative à l'informatique, aux fichiers et aux libertés. En vertu de
					la loi Informatique et Libertés, en date du 6 janvier 1978,
					...
					exerce ce droit : · par mail à l'adresse email WWS77@GMAIL.COM · via
					son espace personnel ;<p></p>
					...
					contenu protégé doit citer l’auteur et sa source. 2<p></p>
					ARTICLE 5 : Responsabilité Les sources des informations diffusées sur
					le site www.Strasgite.fr sont réputées fiables mais le site ne
					...
					le site www.Strasgite.fr ne peut être tenu responsable de la
					...
					ce site. L'Utilisateur s'assure de garder son mot de passe secret.
					...
					site www.Strasgite.fr ne peut être tenu pour responsable d’éventuels
					...
					liens, il sortira du site www.Strasgite.fr. Ce dernier n’a pas de
					...
					www.Strasgite.fr. Les cookies ne contiennent pas d’information
					...
					cookies est utilisée pour améliorer le site www.Strasgite.fr. En
					...
					sein de son logiciel de navigation. 3<p></p>
					ARTICLE 8 : Droit applicable et juridiction compétente La législation
					française s'applique au présent contrat. En cas d'absence de
					résolution amiable d'un litige né entre les parties, les tribunaux
					français seront seuls compétents pour en connaître. Pour toute
					question relative à l’application des présentes CGU, vous pouvez
					joindre l’éditeur aux coordonnées inscrites à l’ARTICLE 1.
				</p>
				<h2>
					EHPAD FULL STACK -- BEST TEAM EVER <span className="heart">♥</span>
				</h2>
			</div>
		</>
	);
