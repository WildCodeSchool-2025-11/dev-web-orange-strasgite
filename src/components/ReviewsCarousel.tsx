...
const avisMockes: Avis[] = [
    {
        ...
        nom: "Jean Dupont",
        note: 5,
        commentaire: "Un excellent gîte avec un emplacement parfait pour explorer Strasbourg."
    },
    {
        id: 2,
        nom: "Marie Martin",
        note: 4,
        commentaire: "Très bien décoré et propre. Un endroit chaleureux pour se reposer."
    },
    {
        id: 3,
        nom: "Pierre Durand",
        note: 5,
        commentaire: "Parfait pour une escapade en famille. Le personnel est très accueillant."
    }
];
